...
4. Connect APEX with Oracle DB by ORDS (keep config environment and production environment seperated) --> C:Users..(config environment)> java -jar C:Users...(production environment)\ords.war serve   
